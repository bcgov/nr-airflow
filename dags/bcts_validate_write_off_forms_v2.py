...
with DAG(
    ...
    catchup=False,
    schedule=None,
    dag_id=f"bcts_validate_write_off_forms_v2",
    default_args=default_args,
    description='DAG to validate write-off forms (new format 2026) for BCTS data in ODS',
) as dag:
    ...
    validate_write_off_forms = KubernetesPodOperator(
        ...
        name=f"bcts-dap-write-off-forms-validation-v2",
