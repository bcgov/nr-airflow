...
with DAG(
    ...
    dag_id=f"bcts_scrape_bcbids_data",
    default_args=default_args,
    description='DAG to scrape BCBIDS data for the weekly TSL report.',
) as dag:
    ...
    bcts_scrape_bcbids_data = KubernetesPodOperator(
        ...
        name=f"run_bcts_scrape_bcbids_data",
    ...
    bcts_scrape_bcbids_data >> task_completion_flag 
